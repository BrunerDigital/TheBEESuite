...
const graphics = [
  {
    ...
    subtitle: "Setup, parent access, kiosk, billing, payments, previous-system cutover, and wider rollout are separate decisions.",
    steps: [
      ...
      ["6", "Monitor launch", "Keep the previous system available until signed cutover; stop on wrong-scope data."],
    ],
