...
const guides: ResourceGuide[] = [
  ...
  {
    id: "director-data-clean-start",
    audience: "Directors and assistant directors",
    title: "School Data Clean-Start Guide",
    summary: "Verify families, children, relationships, safety records, classrooms, staff, tuition, and balances before launch.",
    graphicSrc: "/brand/the-bee-suite/explainers/current/school-launch-gates.png",
    graphicAlt: "Independent school data, access, attendance, billing, payment, and cutover gates",
    icon: ClipboardCheck,
    steps: [
    ...
    visual: [
      { label: "Compare", detail: "Source evidence to BEE data", icon: FileText },
      { label: "Resolve", detail: "Document every exception", icon: ClipboardCheck },
      { label: "Approve", detail: "Decide each gate separately", icon: ShieldCheck },
    ],
  },
  {
    id: "executive-admin",
  ...
  },
  {
    ...
    audience: "Directors and assistant directors",
    title: "Registration Forms & Parent App Invitations",
    summary: "Know when to send the enrollment packet and when to invite an already saved guardian into the parent app.",
    graphicSrc: "/brand/the-bee-suite/explainers/current/parent-access-install.png",
    graphicAlt: "Current secure parent invitation, setup, and installation flow",
    icon: Mail,
    steps: [
      "Registration and parent app access are separate: send the school registration form when paperwork is still needed; send a Parent App Invite after the family, guardian, and child are saved and verified.",
      "From Enrollment CRM > Leads, select the lead and choose Send registration form. To copy the direct school link, use Dashboard > Explore dashboard details > Registration and enrollment forms > Copy registration link.",
      ...
      "If the family is already enrolled and its record is complete, skip the registration form. Scroll to Parent Portal Access, select the exact guardian, and choose Send Parent App Invite. A safely entered current family does not require a prior import batch.",
  ...
  },
  {
    ...
    steps: [
      ...
      "For one approved late fee or vacation credit, use Common billing tasks > One-time fee / credit. Review the projected balance and do not change the child's saved recurring tuition for a one-week exception.",
