...
const graphics = [
  {
    ...
    subtitle: "Setup, parent access, kiosk, billing, payments, and wider rollout are separate decisions.",
    steps: [
      ...
      ["6", "Monitor launch", "Keep current systems available until signed cutover; stop on wrong-scope data."],
    ],
