...
export function buildParentPortalInvitationText({
  ...
  return [
    ...
    "For your security, the first-login password cannot remain active after sign-in. The school will never ask you to send your password, bank login, or full card number by email or text.",
  ].join("\n");
}
