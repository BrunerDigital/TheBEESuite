  ...
  return (
    ...
    <Card id="billing-workbench" className="glass-panel scroll-mt-28">
      ...
      <CardContent className="space-y-4">
        ...
        <Tabs id="billing-actions" value={billingAction} onValueChange={setBillingAction} className="scroll-mt-28">
          <div>
          ...
          <TabsList className="flex flex-wrap justify-start gap-1 group-data-horizontal/tabs:h-auto" aria-label="Common billing tasks">
          ...
          <CollapsiblePanel
            id="billing-more-actions"
            title="More billing tasks"
            summary="Invoice corrections, batch work, payroll deductions, refunds, agency claims, and adjustments"
            defaultCollapsed
          >
            <TabsList className="flex flex-wrap justify-start gap-1 group-data-horizontal/tabs:h-auto" aria-label="More billing tasks">
              <TabsTrigger value="edit" className="h-10 min-h-10"><FilePenLine data-icon="inline-start" />Edit invoice</TabsTrigger>
              <TabsTrigger value="batch" className="h-10 min-h-10"><Rows3 data-icon="inline-start" />Batch tuition</TabsTrigger>
              <TabsTrigger value="weekly-recovery" className="h-10 min-h-10"><Search data-icon="inline-start" />Weekly recovery</TabsTrigger>
              <TabsTrigger value="payroll" className="h-10 min-h-10"><Banknote data-icon="inline-start" />Payroll deduction</TabsTrigger>
              <TabsTrigger value="refund" className="h-10 min-h-10"><RotateCcw data-icon="inline-start" />Refund</TabsTrigger>
              <TabsTrigger value="agency" className="h-10 min-h-10"><BadgeDollarSign data-icon="inline-start" />Agency claims</TabsTrigger>
              <TabsTrigger value="adjustment" className="h-10 min-h-10"><MinusCircle data-icon="inline-start" />Credit / adjustment</TabsTrigger>
            </TabsList>
          </CollapsiblePanel>
