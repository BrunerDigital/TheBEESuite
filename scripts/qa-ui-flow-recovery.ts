...
async function main() {
  ...
  try {
    ...
    const reportChildOption = page.getByRole("option", { name: "Fake Child · Preschool", exact: true });
    await reportChildOption.click();
    await reportChildOption.waitFor({ state: "hidden" });
