...
const graphics = [
  {
    ...
    subtitle: "Setup, parent access, kiosk, billing, payments, previous-system cutover, source-file archival, and wider rollout are separate decisions.",
    steps: [
      ...
      ["6", "Monitor launch", "Keep the previous system through signed cutover. Archive source files separately. Stop on wrong-scope data."],
    ],
  ...
  },
  {
    ...
    subtitle: "Use the verified guardian email, password from the invitation, and secure BEE Suite address.",
    steps: [
      ["1", "Confirm guardian", "Verify email, phone, family link, children, and pickup access."],
      ["2", "Send invitation", "Use the approved invite with the secure URL, email, and password."],
  ...
  },
  {
    ...
    subtitle: "Debit or credit card is presented first. Link and bank account options remain available when the school enables them.",
    steps: [
      ["1", "Open Payments", "Confirm the family, invoice, due date, balance, and amount."],
      ["2", "Choose payment", "Select Debit or credit card, Pay with Link, or Bank account."],
      ["3", "Review total", "Check the exact total. No processing fee is added to the parent payment."],
      ["4", "Secure handoff", "Enter payment details only on the secure processor screen opened from The BEE Suite."],
  ...
  },
  {
    ...
    steps: [
      ...
      ["4", "Review total", "Confirm the amount. No processing fee is added to the parent payment."],
