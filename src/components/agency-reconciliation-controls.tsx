...
type Props = {
  ...
  aging: Aging;
  capabilities: { currentUserId: string; canManageAgencyBilling: boolean; canReviewAgencyPosting: boolean; canCloseAccountingPeriod: boolean; agencyReconciliationActivated: boolean; agencyReconciliationEnabled: boolean; agencyReconciliationBlockers: string[] };
  readOnly: boolean;
  pending: boolean;
