...
export const schoolOnboardingSetupSections = [
  {
    ...
    label: "School business profile",
    owner: "BEE setup + school confirmation",
    href: "/center-dashboard",
    description: "Review the business profile BEE prepared, correct any changed identity or contact details, and save one explicit school confirmation.",
    placeholder: "Optional handoff note about a corrected address, contact, timezone, or licensed capacity",
  },
  {
    field: "classroomSetup",
    storageKey: "classrooms",
    label: "Classrooms and ratios",
    owner: "BEE setup + director",
  ...
  },
  {
    ...
    label: "Family, parent, and child data",
    owner: "BEE setup team + director",
    href: "/billing-settings?view=setup#school-data-setup",
    description: "Choose a guarded import or clean start, then confirm families, guardians, children, authorized pickups, emergency contacts, safety details, schedules, and classrooms.",
    placeholder: "Import or clean-start path\nSource package or manual-entry plan\nFamily/guardian/child review notes\nMissing parent contacts to collect",
  },
  {
    field: "tuitionRateSetup",
    storageKey: "tuitionRates",
    label: "Tuition rates and fees",
    owner: "BEE setup + billing",
  ...
  },
  {
    ...
    owner: "BEE setup + billing owner",
    href: "/billing-invoices?view=payments",
  ...
  },
  {
    ...
    owner: "BEE setup + school approval",
  ...
  },
  {
    ...
    owner: "BEE setup + provider admin",
  ...
  },
  {
    ...
    owner: "BEE setup + school sign-off",
    href: "/dashboard",
