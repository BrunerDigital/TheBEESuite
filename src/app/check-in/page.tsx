      ...
      <div className="flex flex-col gap-6">
        <section className="rounded-2xl border bg-card/80 p-6 shadow-2xl shadow-black/15">
          ...
          <p className="mt-2 max-w-3xl text-sm leading-6 text-muted-foreground">
            Directors can sign into the school account on a lobby tablet or front-desk computer, open the kiosk for the correct school, then leave the tablet on the PIN check-in screen.
          </p>
        </section>
