...
type AgencyAllocation = { id: string; claimId: string; amountCents: number; status: string; requestedById: string; reviewedAt: string | null; reviewNotes: string | null; claim: Claim };
