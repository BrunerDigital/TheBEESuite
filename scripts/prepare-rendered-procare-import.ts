...
fs.writeFileSync(path.join(outputDirectory, "01-procare-import-ready.csv"), `${csv(ready)}\r\n`, "utf8");
fs.writeFileSync(path.join(outputDirectory, "02-procare-needs-account-resolution.csv"), `${csv(needsResolution)}\r\n`, "utf8");
fs.writeFileSync(
