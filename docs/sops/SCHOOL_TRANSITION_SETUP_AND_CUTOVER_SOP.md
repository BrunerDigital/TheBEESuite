...
- [ ] Every staff member expected to sign in has a reconciled application user, usable password-login Auth account, approved application role, and exact school grant; every existing usable account with potential school access has been checked against the approved roster, including unexpected and elevated accounts; intentionally uninvited staff and access exceptions are named, owned, and held off
