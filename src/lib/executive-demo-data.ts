...
export const executiveClassroomDemoRows: ClassroomDashboardData["classrooms"] = [
  {
    id: "exec-demo-classroom-infant-suite",
    name: "Infant Suite",
    ageGroup: "Infants",
    capacity: 10,
    ratioRule: "1:4 target",
    center: { name: "Kid City USA Demo Center", crmLocationId: "Executive demo" },
    _count: { children: 8, staff: 2, dailyReports: 8, incidents: 0 },
  },
  {
    id: "exec-demo-classroom-toddler-studio",
    name: "Toddler Studio",
    ageGroup: "Toddlers",
    capacity: 14,
  ...
  {
    id: "exec-demo-classroom-preschool-lab",
    name: "Preschool Lab",
    ageGroup: "Preschool",
    capacity: 18,
    ratioRule: "1:10 target",
    center: { name: "Kid City USA Demo Center", crmLocationId: "Executive demo" },
    _count: { children: 16, staff: 2, dailyReports: 14, incidents: 0 },
  },
  {
    ...
    center: { name: "Kid City USA Demo Center", crmLocationId: "Executive demo" },
    _count: { children: 17, staff: 2, dailyReports: 15, incidents: 0 },
  },
];
...
export const executiveAnnouncementDemoRows: AnnouncementsPageData["announcements"] = [
  {
    ...
    audience: { centers: "All demo centers", classrooms: ["Infant Suite", "Toddler Studio", "Preschool Lab"] },
    status: "scheduled",
...
export const executiveDailyReportDemoRows: DailyReportsPageData["reports"] = [
  {
    ...
    child: { fullName: "Demo Child A", ageGroup: "Infants" },
    classroom: {
      name: "Infant Suite",
      center: { name: "Kid City USA Demo Center", crmLocationId: "Executive demo" },
    },
  ...
  },
  {
    ...
    suppliesNeeded: null,
    sentAt: null,
    child: { fullName: "Demo Child B", ageGroup: "Toddlers" },
    classroom: {
      name: "Toddler Studio",
      center: { name: "Kid City USA Demo Center", crmLocationId: "Executive demo" },
    },
...
export const executiveParentPortalDemo = {
  family: {
    ...
    guardians: [
      { fullName: "Jordan Demo", email: "demo-parent@example.com", phone: "(555) 014-1200" },
      { fullName: "Taylor Demo", email: "demo-guardian@example.com", phone: "(555) 014-1201" },
    ],
    children: [
      {
