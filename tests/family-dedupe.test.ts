...
test("guardian duplicate scoring matches complete names that both include honorifics", () => {
  const score = scoreGuardianDuplicate(
    {
      id: "guardian_1",
      familyId: "family_1",
...
test("child duplicate scoring preserves direct hyphenated surname boundaries", () => {
  const score = scoreChildDuplicate(
    {
      id: "child_1",
      familyId: "family_1",
...
test("guardian duplicate scoring preserves direct hyphenated surname boundaries", () => {
  const score = scoreGuardianDuplicate(
    {
      id: "guardian_1",
      familyId: "family_1",
...
test("family duplicate scoring preserves direct child hyphenated surname boundaries", () => {
  const score = scoreFamilyDuplicate(
    {
      id: "family_1",
      centerId: "center_1",
...
test("child duplicate scoring canonicalizes omitted hyphens in direct surnames", () => {
  const score = scoreChildDuplicate(
    {
      id: "child_1",
      familyId: "family_1",
...
test("guardian duplicate scoring canonicalizes omitted hyphens in direct surnames", () => {
  const score = scoreGuardianDuplicate(
    {
      id: "guardian_1",
      familyId: "family_1",
