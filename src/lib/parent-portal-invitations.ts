...
export function buildParentPortalInvitationText({
  ...
  return [
    ...
    "",
    "In the portal you can securely pay by debit/credit card or bank account, save either method for autopay, review invoices and payment history, read and send messages, and view reports, incidents, photos, documents, and school updates.",
