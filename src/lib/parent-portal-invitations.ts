...
export function buildParentPortalInvitationText({
  ...
  const tuitionTransitionCopy = billingCutoverApproved
    ? [
        ...
        `Your school has approved its billing cutover to The BEE Suite. Open Payments in your Parent Portal to review any invoice for ${centerLabel}. Confirm the service period, amount, credits, and due date before paying.`,
    ...
    : [
        ...
        "Continue following your school's current tuition instructions. A Parent Portal invitation or a visible Payments page does not move the next tuition cycle to The BEE Suite.",
  ...
  const billingSteps = transitioningFromProcare && billingCutoverApproved
    ? [
        "6. Open Payments in the Parent Portal. Review any invoice, including the family, service period, amount, credits, and due date.",
    ...
    : [
        "6. Open Payments in the Parent Portal. If payment setup is active for your school, choose Save card or Connect bank account, complete the secure payment form, and return to the portal to confirm your saved method.",
  ...
  return [
    ...
    ...billingSteps,
    "",
    "In the portal you can read and send messages and view reports, incidents, photos, documents, and school updates. Payments and secure payment options appear only when your school enables them.",
...
export function buildParentPortalInvitationHtml({
  ...
  const paymentStep = transitioningFromProcare && billingCutoverApproved
    ? `<li><strong>Review an approved tuition invoice:</strong> open Payments, confirm the family, service period, amount, credits, and due date, then choose an available card or bank option. Complete the secure payment form opened from The BEE Suite and wait for confirmation before leaving or trying again.</li>`
    : `<li><strong>Set up payments when your school enables them:</strong> open Payments, choose Save card or Connect bank account, complete the secure payment form, and return to the portal to confirm the saved method. If checkout is not active yet, stop and contact the school.</li>`;
  return `<!doctype html>
<html>
          ...
          <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:680px;background:#fff;border:1px solid #e5dfcf;border-radius:22px;overflow:hidden">
            ...
            <tr>
              <td style="padding:32px 34px">
                ...
                <p style="font-size:15px;line-height:1.65">Read and send messages and view daily reports, incidents, photos, documents, and school updates. Payments and secure payment options appear only when your school enables them.</p>
...
export function buildParentPortalGuideText({
  ...
  return [
    ...
    "5. If your school has enabled payments, open Payments and choose Save card or Connect bank account. Complete the secure payment form and return to the portal to confirm the saved method.",
    "",
    "WHAT YOU CAN DO",
